...
int main()
{
    ...
    while (true)
    {
        if (board_output_feature_map.empty())
        {
    ...
    for (int f = 0; f < 64; f++)
    {
        for (int i = 0; i < 368; i++)
        {
            for (int j = 0; j < 640; j++)
            {
                fixp_conv_layer_output_feature_map[f][i][j] = data[f * 368 * 640 + i * 640 + j];
                // if (fixp_conv_layer_output_feature_map[f][i][j] != 0)
                // {
                //     std::cout << "read: " << fixp_conv_layer_output_feature_map[f][i][j] << std::endl;
                //     std::cout << "golden: " << conv_layer_golden_output_feature_map[f][i][j] << std::endl;
                // }
